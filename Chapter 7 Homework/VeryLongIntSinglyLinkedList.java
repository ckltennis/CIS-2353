...
public class VeryLongIntSinglyLinkedList
{
    protected SinglyLinkedList<Integer> digits;
    ...
    public VeryLongInt (String s) 
    {
        ...
        digits = new SinglyLinkedList<Integer> ();
    ...
    public VeryLongInt( int n )
    {
      ...
      {
         digits.addToFront( (int) ( ( n % factor ) / ( factor / 10 ) ) );
      }
    }
    ...
    public void add (VeryLongIntLinkedList otherVeryLong) 
    {
        ...
        SinglyLinkedList<Integer> sumDigits = new SinglyLinkedList<Integer>();

        for (int i = 0; i < largerSize; i++) 
        {
            partialSum = least (i) + otherVeryLong.least (i) + carry;
            carry  = partialSum / BASE;
            sumDigits.addToFront (partialSum % BASE);
        } // for

        if (carry == 1)
            sumDigits.addToFront (carry);
        digits = sumDigits;        
 } // method add
